...
(function (marmoset) {
    ...
    ShaderCache.prototype.fetch = function (a, b) {
        "undefined" != typeof ShaderTable ? void 0 !== ShaderTable[a] ? this.resolveIncludes(new String(ShaderTable[a]), b) : b("") : Network.fetchText("shader/" + a, function (a) {
